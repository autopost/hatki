/**
 * Created by vladyslavprytula on 6/10/14.
 */
var map;
...
//var points = [
//new OpenLayers.Geometry.Point(55, 20).transform(new OpenLayers.Projection("EPSG:4326"), map.getProjectionObject()),
//new OpenLayers.Geometry.Point(16.37, 48.208).transform(new OpenLayers.Projection("EPSG:4326"), map.getProjectionObject())];
